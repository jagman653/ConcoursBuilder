 ...
 * @author Ed Sowell
 */
public class InterchangeTimeslotsDialog extends javax.swing.JDialog {
     ...
     */
    public InterchangeTimeslotsDialog(java.awt.Frame parent, boolean modal, Concours aConcours, Map<Integer, String> aTimeslotIndexToTimeStringMap,  Map<String, Integer> aTimeStringToTimeslotIndexMap) {
        super(parent, modal);
        initComponents();
    ...
    private void btnInterchangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInterchangeActionPerformed
        ...
        theConcours.switchTimeslots(JudgeAssignGUI.theConcours.GetJudgeAssignments(), theCurrentTimeslotIndex, theNewTimeslotIndex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterchangeTimeslotsDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
