...
/*
INCOMPLETE, NOT USED                       INCOMPLETE, NOT USED            INCOMPLETE, NOT USED              INCOMPLETE, NOT USED
*/
 ...
 *                   INCOMPLETE, NOT USED
 */
public class AddConcoursJudgeDialog_2 extends javax.swing.JDialog {
     ...
     */
    public AddConcoursJudgeDialog_2(java.awt.Frame parent, boolean modal,  Connection aConnection, Concours aConcours, ConcoursPersonnel aConcoursPersonnel, MasterListRepository aRepository, JCNAClass[] aClassMasterList, boolean aSystemexitwhenclosed, boolean aAddJudge) {
        super(parent, modal);
        ...
        //myInitComponents();
        initComponents();
        rejectedClasses = new ArrayList<>();

        theConcours = aConcours;
        theConcours.GetLogger().info("Starting AddConcoursJudge_2");
    ...
    //                    ALL of this put into a separate dialog ConcoursJudgePrefDialog
    //
    /*
...
*/
    ...
    private void initComponents() {
        ...
        panePrefs = new javax.swing.JPanel();
        btnSetJudgingPreferences = new javax.swing.JButton();
        ...
        btnSetJudgingPreferences.setText("Set Judging Preferences");
        btnSetJudgingPreferences.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSetJudgingPreferencesActionPerformed(evt);
            }
        });

        javax.swing.GroupLayout panePrefsLayout = new javax.swing.GroupLayout(panePrefs);
        panePrefs.setLayout(panePrefsLayout);
        panePrefsLayout.setHorizontalGroup(
            panePrefsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panePrefsLayout.createSequentialGroup()
                .addGap(260, 260, 260)
                .addComponent(btnSetJudgingPreferences)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panePrefsLayout.setVerticalGroup(
            panePrefsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panePrefsLayout.createSequentialGroup()
                .addGap(28, 28, 28)
                .addComponent(btnSetJudgingPreferences)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(pnlPersonalInfoContent, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(panePrefs, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(300, 300, 300)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panePrefs, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void UpdateMasterPersonAttributes() {
       ...
       // System.out.println("cboUniqueName ItemEvent.SELECTED ");
        selectedMasterPerson = (MasterPersonExt) AddConcoursJudgeDialog_2.this.cboUniqueName.getSelectedItem();
...
*/   
    ...
    private void btnAddJudgeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddJudgeActionPerformed
       ...
       // Long personAlreadyInConcoursJudges;
        MasterPersonExt selectedMasterPerson = (MasterPersonExt) AddConcoursJudgeDialog_2.this.cboUniqueName.getSelectedItem();
       ...
       if (concoursJudgeNode == 0) { 
           ...
           // the previouse Judge Assignment is now invalid so manual editing is disabled.
            ...
            try { 
                ...
                //Logger.getLogger(AddConcoursJudgeDialog_2.class.getName()).log(Level.SEVERE, null, ex);
                String msg = "SQLException in AddConcoursJudgeDialog_2 call to SetSettingsTableJAState";
                okDialog(msg);
...
/*
    ...
    */
    ...
    private void btnSetJudgingPreferencesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetJudgingPreferencesActionPerformed
        /* Create and display the dialog */
        ConcoursJudgePrefDialog judgePrefDialog = new ConcoursJudgePrefDialog(new javax.swing.JFrame(), true, theConcours, theJCNAClassGroups, classMasterListArray);
        judgePrefDialog.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosing(java.awt.event.WindowEvent e) {
                theConcours.GetLogger().info("Returning from judgePrefDialog");                    }
            });
        judgePrefDialog.setDefaultCloseOperation(HIDE_ON_CLOSE);
        judgePrefDialog.setVisible(rootPaneCheckingEnabled);       
        ArrayList<String> rejectedClasses =  judgePrefDialog.getRejectList();

    }//GEN-LAST:event_btnSetJudgingPreferencesActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddConcoursJudgeDialog_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                AddConcoursJudgeDialog_2 theDialog = new AddConcoursJudgeDialog_2(new javax.swing.JFrame(), true, conn, theConcours, theConcoursPersonnel, masterList, classMasterArray, true, true);
    ...
    private javax.swing.JButton btnSetJudgingPreferences;
    ...
    private javax.swing.JPanel panePrefs;
