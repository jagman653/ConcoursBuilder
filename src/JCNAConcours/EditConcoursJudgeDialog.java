 ...
 * @author Ed Sowell
 */
public class EditConcoursJudgeDialog extends javax.swing.JDialog {
     ...
     */
    public EditConcoursJudgeDialog(java.awt.Frame parent, boolean modal, Connection aConnection, Concours aConcours, ConcoursPersonnel aConcoursPersonnel,  JudgeRepository aRepository, JCNAClass[] aClassMasterList, boolean aSystemexitwhenclosed) {
        super(parent, modal);
        ...
        PopulatePrefPanelEditJudge(theConcours);
        theLogger.info("Finished PopulatePrefPanelEdit in EditConcoursJudgeDialog");
        this.setSize(1900,800); /// 5/19/2017
        // custom filterator
...
private void PopulatePrefPanelEditJudge(Concours aConcours)   {
...
//       pnlPreferenceContent.add(pnlJCNAClassGroups, java.awt.BorderLayout.WEST);
      ...
      //  pnlJCNAClasses.removeAll(); // clearing the checkboxes inserted with the GUI designer
       ...
       pnlPreferenceContent.setPreferredSize(new Dimension(1900, 320)); //  NOTE: this will be too big once I get the Classes panel set right!!!!!!!!!!!!!!!!!!!
//        pnlPreferenceContent.setLayout(new java.awt.BorderLayout());
    ...
    private void initComponents() {
        ...
        pnlPreferenceContent.setBorder(javax.swing.BorderFactory.createTitledBorder("Select judging preferences"));
        pnlPreferenceContent.setToolTipText("Select/deselect items in left or right panel");
    ...
    private void UpdateJudgePeronalAttributes() {
       ...
       // System.out.println("cboUniqueName ItemEvent.SELECTED ");
        selectedJudge = (Judge) EditConcoursJudgeDialog.this.cboJudgeUniqueName.getSelectedItem();
    ...
    private void myInitComponents(){
        ...
        pnlPreferenceContent.setToolTipText("Select/deselect boxes in left or right panel.");
    ...
    private void btnSaveJudgeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveJudgeActionPerformed
        ...
        Judge selectedJudge = (Judge) EditConcoursJudgeDialog.this.cboJudgeUniqueName.getSelectedItem();
       ...
       // the previouse Judge Assignment is now invalid so manual editing is disabled.
        ...
        try { 
            loadSQLiteConcoursDatabase.SetSettingsTableJAState(theDBConnection, false) ;
                ...
                String msg = "SQLException in EditConcoursJudgeDialog call to SetSettingsTableJAState";
                okDialog(msg);
   ...
   return list;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditConcoursJudgeDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Logger.getLogger(EditConcoursJudgeDialog.class.getName()).log(Level.SEVERE, null, ex);
                ...
                EditConcoursJudgeDialog theDialog = new EditConcoursJudgeDialog(new javax.swing.JFrame(), true,  conn, theConcours, theConcoursPersonnel, judgeList, classMasterArray, true);
